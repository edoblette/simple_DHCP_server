...
class DHCP_client(object):
    def client(self):
        ...
        print("YIADDR : " + DHCP_client.ip_addr_format(DHCP_client.packet_analyser(packet)[8]))
        print("SIADDR : " + DHCP_client.ip_addr_format(DHCP_client.packet_analyser(packet)[9]))
        print("option : " + '{} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {}'.format(*bytearray(DHCP_client.packet_analyser(packet)[13])))
    ...
    def ip_addr_format(yiaddr):
        yiaddr = '{}.{}.{}.{}'.format(*bytearray(yiaddr))
